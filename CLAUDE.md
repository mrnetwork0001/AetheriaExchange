...
**Target Network**: X Layer EVM (Mainnet Chain ID: 196, Testnet Chain ID: 1952)
...
- **RPC Endpoints**:
  ...
  - X Layer Testnet: `https://testrpc.xlayer.tech` (Chain ID: 1952)
...
1. **X Layer EVM Native**: All contract deployments, RPC calls, and transaction signatures MUST target X Layer EVM (Chain ID 1952 for Testnet, 196 for Mainnet).
